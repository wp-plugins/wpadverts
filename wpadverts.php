...
function adverts_init_frontend() {
    ...
    wp_register_script('adverts-frontend', ADVERTS_URL . '/assets/js/adverts-frontend.js');
    wp_register_script('adverts-frontend-add', ADVERTS_URL . '/assets/js/adverts-frontend-add.js');
...
function adverts_init_admin() {
    ...
    wp_register_script('adverts-admin', ADVERTS_URL . '/assets/js/adverts-admin.js', array(), false, true);
    wp_register_style('adverts-admin', ADVERTS_URL . '/assets/css/adverts-admin.css');
    
    wp_register_script( 'adverts-admin-updates', ADVERTS_URL . '/assets/js/adverts-admin-updates.js', array(), false, true );
